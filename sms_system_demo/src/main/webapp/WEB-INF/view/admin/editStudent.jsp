				    ...
				    <div class="panel-body">
						<form class="form-horizontal" role="form" action="admin/editStudent" id="editfrom" method="post">
							  ...
							  <div class="form-group">
							    ...
							    <div class="col-sm-10">
								    <input type="date" value="<fmt:formatDate value="${student.birthyear}"  pattern="yyyy-MM-dd" dateStyle="medium" />" name="birthyear"/>
							    </div>
							  </div>
							  <div class="form-group">
							    <label for="inputPassword3" class="col-sm-2 control-label" name="grade">入学时间</label>
							    <div class="col-sm-10">
								    <input type="date" value="<fmt:formatDate value="${student.grade}" pattern="yyyy-MM-dd" dateStyle="medium"  />" name="grade"/>
							    </div>
							  </div>
							  <div class="form-group">
